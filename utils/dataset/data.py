...
def prepare_train_data(dataset='cifar10', datadir='/home/liulian/datasets', batch_size=128,
...
def prepare_test_data(dataset='cifar10', datadir='/home/liulian/datasets', batch_size=128,
